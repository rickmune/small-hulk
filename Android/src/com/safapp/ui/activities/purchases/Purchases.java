...
public class Purchases extends FragmentActivity implements ScrollTab.OnSwipeTabs{

	private final static String Tag = "Purchases ";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.purchasetab_activity);
		Log.d(Tag, "onCreate");
		mViewPager = (ViewPager) findViewById(R.id.viewpager);
		mTabs = (ScrollTab) findViewById(R.id.swipeytabs);
		adapter = new SwipeyTabsPagerAdapter(getSupportFragmentManager(), this);
		adapter.addTab(PurchasesFrag.class, null);
		adapter.addTab(PurchasesSummaryFrag.class, null);
